...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../webapp/scripts/Panel"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Panel_1 = require("../webapp/scripts/Panel");
    var RestConnector = (function (_super) {
        ...
        RestConnector.setResponse = function (response, obj) {
            app.removePanel(Panel_1.PanelType[Panel_1.PanelType.Schema], true);
            ...
            if (result.resultType == 'RESULTSET') {
                ...
                app.getPanel(Panel_1.PanelType[Panel_1.PanelType.Connect]).hide();
                app.newPanel(Panel_1.PanelType.Schema).show();
                status.value = 'OK';
